        ...
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <LuSparkle size={16} className='bg-green-50 text-green-600' />
          ...
          <div className='text-center mb-28'>
            ...
            <motion.p
              ...
              Ace your interviews with PrepPilot-AI. Get personalized feedback and build the skills needed to land your dream job.
            </motion.p>
              ...
              [
                {
                  ...
                  desc: "AI ddjusts difficulty based on your answers."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "Step 2",
